...
[![Go Reference](https://pkg.go.dev/badge/github.com/fyipedia/unitfyi-go.svg)](https://pkg.go.dev/github.com/fyipedia/unitfyi-go)
...
`go get github.com/fyipedia/unitfyi-go`
...
func main() {
    ...
    result, err := client.Search("kilogram")
    if err != nil {
        panic(err)
    }
